    ...
    <div className='flex flex-col items-start gap-8 lg:flex-row'>
      ...
      <div className='flex-1 bg-white w-full mb-8 border border-gray-300 rounded-lg
        ...
        <form className=' flex flex-col gap-y-4'>
          ...
          <textarea name="" id="" cols="30" rows="10" placeholder='Message*' defaultValue='Hello, I am interested in [Modern apartment]'
          ...
          <div className='flex gap-x-2'>
            ...
            <button className='border border-violet-700 hover:border-violet-500 hover:text-violet-500 rounded px-4 
